# this code will download a raw dataset as specified in the CodeBook.md
# and create a tidy data set.  Make sure to change the working directory 
# to your working directory in line 5.

working.directory <- "/Users/Grays/Documents/Coursera" 
